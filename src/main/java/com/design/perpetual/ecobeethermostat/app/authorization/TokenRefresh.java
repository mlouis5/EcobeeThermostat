...
public class TokenRefresh implements Callable<Map<Class<?>, Object>> {
    ...
    private PinAuthorization authorization;
    ...
    public TokenRefresh(PinAuthorization autho, String appKey) throws
    ...
    public void setAuthorization(PinAuthorization autho) throws
