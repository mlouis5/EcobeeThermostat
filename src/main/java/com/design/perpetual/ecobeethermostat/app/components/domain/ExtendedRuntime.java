 ...
 * @author Mac
 */
@TypeInformation(typeLink = "https://www.ecobee.com/home/developer/api/documentation/v1/objects/ExtendedRuntime.shtml")
public class ExtendedRuntime {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 29 * hash + Objects.hashCode(this.lastReadingTimestamp);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ExtendedRuntime other = (ExtendedRuntime) obj;
        if (!Objects.equals(this.lastReadingTimestamp, other.lastReadingTimestamp)) {
            return false;
        }
        return true;
    }
