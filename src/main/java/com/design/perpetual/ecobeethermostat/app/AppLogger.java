package com.design.perpetual.ecobeethermostat.app;
...
public class AppLogger {
  ...
  public void configLevel(){
    switch (appState){
      case DEV: log.setLevel(Level.ALL); break;
      case QA: log.setLevel(Level.DEBUG); break;
      case PROD: log.setLevel(Level.INFO); break;
    }
  }
  ...
  public <T> void println(T str) {
    if (appState == AppState.DEV || appState == appState.QA) {
      System.out.println(Objects.isNull(str) ? "null" : str);
    }
  }

  public <T> void print(T str) {
    if (appState == AppState.DEV || appState == appState.QA) {
      System.out.print(Objects.isNull(str) ? "null" : str);
    }
  }
}
